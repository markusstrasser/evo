...
- **Intent-level:** 41 / 43 complete (needs both an implementing intent and a test citation)
...
- **Deterministic FR fixtures:** {:registry-golden 1, :generated-variant 1}. Generated variants are pressure tests and do not inflate registry scenario coverage.
