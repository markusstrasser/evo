...
|-------|----------|------|------|--------|-------------|
| derive-indexes | 🔥 critical | ❌ | ❌ | 🔴 missing | All operations trigger automatic index derivation; never mutate derived state directly |
| undo-restores-all | 🔥 critical | ❌ | ❌ | 🔴 missing | Undo/redo restores block content + caret position + selection state |
...
| visible-outline | ⬆️ high | ❌ | ❌ | 🔴 missing | Navigation stays within visible outline (respects page, zoom, folding) |
| idle-guard | ⬆️ high | ❌ | ❌ | 🔴 missing | Idle state requires explicit action to enter edit/selection; prevents accidental state changes |
| selection-clears-edit | ⬆️ high | ❌ | ❌ | 🔴 missing | Entering selection mode clears editing state |
| quick-switcher | ⬆️ high | ✅ | ❌ | 🟡 implemented-untested | Cmd+K opens global search overlay |
| slash-palette | ⬆️ high | ✅ | ❌ | 🟡 implemented-untested | Slash (/) opens inline command menu |
| slash-select | ⬆️ high | ✅ | ❌ | 🟡 implemented-untested | Enter inserts the selected slash command |
...
| slash-navigate | ➡️ medium | ✅ | ❌ | 🟡 implemented-untested | Arrow keys move slash selection with wraparound |
