...
(def criteria
  {:functional-fit     {:weight 0.25 :type :objective}
   :maintainability    {:weight 0.15 :type :subjective}
   :performance        {:weight 0.05 :type :measurable}
   :clojure-idiomatic  {:weight 0.1 :type :subjective}
   :simplicity         {:weight 0.25 :type :subjective}
   :extensibility      {:weight 0.20 :type :subjective}})
